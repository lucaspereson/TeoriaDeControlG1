...
void PROGRAM0_init__(PROGRAM0 *data__, BOOL retain) {
  __INIT_VAR(data__->SENSOR_INC,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->LUZ_VERDE,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->LUZ_AZUL,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->LUZ_ROJA,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->RETARDO_LR,__time_to_timespec(1, 250, 0, 0, 0, 0),retain)
  __INIT_VAR(data__->RETARDO_LA,__time_to_timespec(1, 0, 3, 0, 0, 0),retain)
  ...
  __INIT_VAR(data__->_TMP_SEL42_OUT,__BOOL_LITERAL(FALSE),retain)
}
...
void PROGRAM0_body__(PROGRAM0 *data__) {
  ...
  __SET_VAR(data__->,_TMP_NOT2_OUT,,!(__GET_VAR(data__->SENSOR_INC,)));
  __SET_VAR(data__->TOF1.,IN,,__GET_VAR(data__->SENSOR_INC,));
  __SET_VAR(data__->TOF1.,PT,,__GET_VAR(data__->RETARDO_LA,));
  TOF_body__(&data__->TOF1);
  __SET_VAR(data__->,_TMP_NOT5_OUT,,!(__GET_VAR(data__->TOF1.Q,)));
  ...
  __SET_VAR(data__->,LUZ_VERDE,,__GET_VAR(data__->_TMP_AND6_OUT,));
  __SET_VAR(data__->,_TMP_XOR35_OUT,,XOR__BOOL__BOOL(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
    (UINT)2,
    (BOOL)__GET_VAR(data__->TOF1.Q,),
    (BOOL)__GET_VAR(data__->SENSOR_INC,)));
  __SET_VAR(data__->,LUZ_AZUL,,__GET_VAR(data__->_TMP_XOR35_OUT,));
  __SET_VAR(data__->TOF0.,IN,,__GET_VAR(data__->TP0.Q,));
  __SET_VAR(data__->TOF0.,PT,,__GET_VAR(data__->RETARDO_LR,));
  TOF_body__(&data__->TOF0);
  __SET_VAR(data__->,_TMP_NOT24_OUT,,!(__GET_VAR(data__->TOF0.Q,)));
  __SET_VAR(data__->TP0.,IN,,__GET_VAR(data__->_TMP_NOT24_OUT,));
  __SET_VAR(data__->TP0.,PT,,__GET_VAR(data__->RETARDO_LR,));
  ...
  __SET_VAR(data__->R_TRIG1.,CLK,,__GET_VAR(data__->_TMP_AND26_OUT,));
  R_TRIG_body__(&data__->R_TRIG1);
  __SET_VAR(data__->CTU0.,CU,,__GET_VAR(data__->R_TRIG1.Q,));
  __SET_VAR(data__->CTU0.,R,,__GET_VAR(data__->_TMP_NOT2_OUT,));
  __SET_VAR(data__->CTU0.,PV,,20);
  CTU_body__(&data__->CTU0);
  __SET_VAR(data__->,_TMP_SEL42_OUT,,SEL__BOOL__BOOL__BOOL__BOOL(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
    (BOOL)__GET_VAR(data__->CTU0.Q,),
    (BOOL)__GET_VAR(data__->_TMP_AND26_OUT,),
    (BOOL)__GET_VAR(data__->CTU0.Q,)));
  __SET_VAR(data__->,LUZ_ROJA,,__GET_VAR(data__->_TMP_SEL42_OUT,));
